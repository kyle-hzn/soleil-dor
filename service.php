...
if($servicesHeroType): ?>
    ...
    <section class="services-hero pt-32 lg:h-screen relative mb-24">
        <div class="flex flex-col lg:flex-row justify-between h-full">
            <div class="flex flex-col lg:w-7/12 gap-4">
                <h1 class="heading--1 text--white mb-8">
                ...
                <div class="flex flex-col lg:flex-row gap-2 mb-8 lg:mb-0">
                    <div class="services-hero__card inline-flex gap-4 items-center">
            ...
            <div class="flex lg:flex-row lg:w-5/12 gap-6 lg:items-end">
                <div class="services-hero__img services-hero__img--1 h-full lg:h-3/6 lg:w-2/6">
                ...
                <div class="services-hero__img services-hero__img--2 h-full lg:w-4/6">
        ...
        <div class="scroll-icon hidden lg:inline-flex items-center justify-center absolute bottom-0">
    ...
    <section class="services-hero pt-32 mb-24">
        <div class="flex flex-col lg:flex-row justify-between mb-24">
            <h1 class="heading--1 text--white mb-8 lg:w-4/12">
